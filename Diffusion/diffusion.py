...
class Diffusion(nn.Module):
    def __init__(
        ...
        *,
        ...
        # ###########################################################
        self.register_buffer('betas', 1. - cosine_schedule(timesteps))
        alphas = 1. - self.betas
    ...
    def p_sample(self, x, t, t_index):
        ...
        x0_pred = sqrt_recip_alphas_cumprod_t * x - sqrt_recipm1_alphas_cumprod_t * model_mean
        ...
        posterior_log_variance_clipped_t = extract(self.posterior_log_variance_clipped, t, x.shape)
        ...
        sample = posterior_mean + torch.exp(0.5 * posterior_log_variance_clipped_t) * noise
        return sample
        # ####################################################
    ...
    def forward(self, x_0, noise):
        ...
        return self.p_losses(x_0, torch.randint(0, self.num_timesteps, (b,), device=device), noise)
